...
if __name__=="__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Perform operations from an operations file')
    parser.add_argument('operations_file', type=str,
                    help='Path to the operations file')
    ...
    for op, operations in operations_dict.items():
        ...
        with Pool(args.n_processes) as pool:
            for _ in tqdm(pool.imap(process_one_operation, operations), total=len(operations)):
                continue
